            ...
            <div className="flex justify-between items-center py-2 border-t-[1px] border-[#D0D0D0] lg:py-1.5 lg:border-0">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <span className="font-medium text-xs leading-[18px] text-[#151515]">{props.airplane_name} - {props.class.class_name}</span>
              ...
              <div className="flex items-center gap-4 w-full px-0 py-0 lg:py-2.5 lg:px-[30px]">
                <div className="flex items-center gap-3 w-full">
                  <div className="flex flex-1 flex-col justify-center items-center gap-1 max-w-[48px]">
                    <span className="font-bold text-sm text-[#151515]">{departureTime.format("HH:mm")}</span>
                  ...
                  <div className="flex flex-2 flex-col justify-center items-center">
                    <span className="font-medium text-xs leading-[18px] text-[#8A8A8A]">{hourDifference}h {minuteDifference}m</span>
                  ...
                  <div className="flex flex-1 flex-col justify-center items-center gap-1 max-w-[48px]">
                    <span className="font-bold text-sm text-[#151515]">{arrivalTime.format("HH:mm")}</span>
